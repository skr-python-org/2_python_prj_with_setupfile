...
GH_USERNAME_VAR = os.getenv("GH_USERNAME_VAR")
GH_TOKEN_VAR = os.getenv("GH_TOKEN_VAR")
...
PACKAGE_REQUIREMENTS = [
    ...
    "boto3==1.34.51",
    "wheel",
    f"python_generic_func_library @ git+https://{GH_USERNAME_VAR}:{GH_TOKEN_VAR}@github.com/skr-python-org/python_generic_func_library.git@v1.0.0"
